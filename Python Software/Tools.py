...
class Tools: # Diese Klasse stellt Werkzeuge die von verschiedenen Oberklassen verwendet werden kann
    ...
    def check_template (self, checkrow): # Prüft erhaltene Zeile auf Elemente der Schneidvorlage und gibt die Infos zurück
        ...
        elif any(x in checkrow for x in ['ROTATE','rotate']): # Suche nach den Begriffen 'rotate;ROTATE' und gebe "vorhanden"-Info zurück
            return (1,None,None)
        elif any(x in checkrow for x in ['WAIT','wait']): # Suche nach den Begriffen 'wait;WAIT' und gebe "vorhanden"-Info zurück
            return (2,None,None)
        else: # Gebe zurück das nichts gefunden wurde
            return False
